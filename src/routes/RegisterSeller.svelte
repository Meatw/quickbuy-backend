<script>
  ...
  async function handleRegister(e) {
    ...
    // Validate form
    if (!fullName || !email || !storeName || !storeDescription || !phoneNumber || !password || !confirmPassword) {
  ...
  <div class="register-container">
    <div class="register-card">
      ...
      <div class="tab-container">
        ...
        <Link to="/register/seller" class="tab active">Register</Link>
      </div>
      
      <div class="account-type">
        <h3>Account Type</h3>
        <div class="account-options">
          <Link to="/register/customer" class="account-option">
            <span>Register as Customer</span>
          </Link>
          <label class="account-option active">
            <input type="radio" name="accountType" value="seller" checked />
